...
function HeroBadge() {
  ...
  useEffect(() => {
    ...
    const loop = () => {
      if (!on) return;
      setVisible(true);
      setTimeout(() => { if (on) setVisible(false); }, 4000);
      setTimeout(() => { if (on) loop(); }, 6000);
    };
    loop();
    return () => { on = false; };
  }, []);
  ...
  return (
    <div
      ...
      style={{
        backgroundColor: "rgba(27,58,92,0.90)",
...
export function HeroGallery({ images, accentColor = "#1B3A5C" }: { images: string[]; accentColor?: string }) {
      ...
      <div className="relative aspect-square overflow-hidden rounded-2xl -mx-4 sm:-mx-6 md:mx-0 md:rounded-2xl md:border"
        ...
        <div className="flex h-full flex-col items-center justify-center gap-4 p-8">
          ...
          <div className="text-center">
            <p className="text-sm font-semibold" style={{ color: "#9B9790" }}>Soleva</p>
          ...
          {visibleThumbs.map((src, i) => {
            ...
            return (
              <button
                ...
                style={{
                  borderRadius: 10,
                  border: isActive ? `2px solid ${accentColor}` : "2px solid #E2E4E8",
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                ...
                <textarea id="ar-rv-text" name="rv-text" placeholder="Raccontaci la tua esperienza con i nostri sandali…" required
