...
async function main() {
  ...
  const [prod] = await sql`SELECT id FROM products WHERE slug = 'belliva' LIMIT 1`;
  ...
  /* ── 18 recensioni ── */
  const reviews = [
    { author: "Giovanna M.", rating: 5, body: "Le uso ogni mattina per la passeggiata. Cammino più dritta e alla sera non ho più le gambe pesanti. Consigliatissime.", reply: "Grazie Giovanna! Siamo felici che Belliva faccia parte della tua routine quotidiana." },
    { author: "teresa.c", rating: 5, body: "arrivate in 3 giorni, le ho messe subito. La suola si sente diversa da subito, più fluida nel passo. Molto soddisfatta", reply: "Grazie Teresa! Buon cammino con Belliva." },
    { author: "Federica Longo", rating: 5, body: "Lavoro 8 ore in piedi come commessa. Da quando le uso la schiena non mi fa più male la sera. Migliori di quelle che avevo prima.", reply: "È proprio per chi lavora in piedi tutto il giorno che Belliva fa la differenza. Grazie Federica!" },
    ...
    { author: "Lucia", rating: 5, body: "Ho 65 anni e soffro di fascite plantare da anni. Con queste scarpe riesco a fare una passeggiata intera senza dolore. Non le cambio con niente.", reply: "Grazie Lucia, questo è esattamente il risultato per cui abbiamo scelto Belliva. Un abbraccio!" },
    ...
    { author: "Roberta F.", rating: 5, body: "Sono andata al lavoro con le Belliva il primo giorno e tutti i colleghi mi hanno chiesto che scarpe portassi. Esteticamente bellissime e comode.", reply: "Che bella soddisfazione! Belliva nasce per essere bella e funzionale allo stesso tempo. Grazie Roberta." },
    ...
    { author: "Bruna Sartori", rating: 5, body: "Cammino un'ora al giorno con le amiche. Da quando ho le Belliva non ho più i piedi gonfi la sera. Mie amiche le vogliono anche loro.", reply: "Effetto passaparola. Grazie Bruna, buone camminate a tutta la compagnia." },
